...
| CTD-02 | R01、R02、R03 | 混合计划中的受跟踪目录位于首、中、尾位置；两种 dry-run。 | 合法临时目标也全部保留，首次删除不能早于整批验证。 |
| CTD-03 | R01、R03、R07 | 受跟踪路径含空格、方括号、标点、非 ASCII 和多级目录；两种 dry-run。 | 按实际目录边界发现源内容并拒绝，所有原始字节不变。 |
